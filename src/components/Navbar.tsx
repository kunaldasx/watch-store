...
export function Navbar() {
  ...
  const navLinks = ['Collections', 'Brands', 'Optical', 'Sunglasses', 'Gifting', 'About'];
    ...
    <>
      ...
      >
        <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          {/* Logo */}
          <a href="/" className="text-2xl md:text-3xl font-serif tracking-widest font-bold uppercase text-foreground">
            VISO
          </a>
