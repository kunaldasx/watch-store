      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          <h2 className="text-3xl md:text-5xl font-serif text-foreground leading-tight mb-8">
            Curating the world's most exceptional timepieces since 1998.
          </h2>
          <p className="text-lg text-foreground/70 font-light leading-relaxed">
            We believe that a watch is more than an instrument that tells time. It is a masterpiece of engineering, a symbol of heritage, and an intimate companion for life's defining moments.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 pt-12 border-t border-border/50">
          <AnimatedCounter value={100} label="Boutiques Pan India" />
          <AnimatedCounter value={50} label="Happy Customers" />
          <AnimatedCounter value={500} label="Luxury Brands" />
        </div>
      </div>
    </section>
  );
